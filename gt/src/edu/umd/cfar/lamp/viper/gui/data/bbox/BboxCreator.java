...
public class BboxCreator extends CanvasCreator {
	...
	public void displaySelected() {
		...
		rect2.setStroke(colorTable.getSelectedStroke());
		rect2.setStrokePaint(colorTable.getSelectedColor());
	}
	...
	public void mousePressed(PInputEvent e) {
		...
		// Added by Sohil 23 Nov, 2016
		rect2.setBounds(pressPoint.getX(), pressPoint.getY() + 100, 0, 0);

		dragPoint = pressPoint;
		getAssistant().addShape(rect);
		getAssistant().addShape(rect2);
		updateRectangle();
	}
	...
	public void mouseReleased(PInputEvent e) {
		...
		BoundingBox boundBox = new BoundingBox(rect.getX(), rect.getY(),
		...
		//Added by Sohil 23 Nov, 2016
		BoundingBox boundBox2 = new BoundingBox(rect2.getX(), rect2.getY(),
				rect2.getWidth(), rect2.getHeight());
		setAttrValueInMediator(boundBox2);
	...
	/**
	 * updateRectFromcenter There's an easier way (I think) with
	 * AffineTransforms
	 */
	private void updateRectFromCenter() {
		...
		b2.setRect(b.getX(), b.getY()+300, b.getWidth(), b.getHeight());
		rect2.setPathTo(b2);
	}
